...
--
-- Database: `ecommerceassignmenttwo`
--
CREATE DATABASE IF NOT EXISTS `ecommerceassignmenttwo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ecommerceassignmenttwo`;
...
(1, 1, 'Marc-Anthony', 'Mawc', 'Iacobellis');
...
CREATE TABLE `publication` (
  ...
  `profile_id` int(11) NOT NULL,
  `publication_title` varchar(40) NOT NULL,
  `publication_text` varchar(300) NOT NULL,
...
CREATE TABLE `publication_comment` (
  ...
  `publication_id` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `publication_comment_text` varchar(2500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Marc', '$2y$10$LWicXiSXMOlisC2cvGpkKedBSbmMI7yR49iclw9YUiMAY2cDMQ6QK', 1);
...
--
ALTER TABLE `profile`
  ADD CONSTRAINT `user_id_foreignKeyConstraint` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
